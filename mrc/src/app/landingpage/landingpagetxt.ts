export const text = 
{
  ...
  serviceCard:{
    ...
    reforma:'Na área de reformas, materializamos transformações. Realizamos reformas que atendendem às expectativas dos clientes e criando ambientes renovados e funcionais',
    consultoria:'Consultoria de engenharia comprometida com o sucesso de seus projetos. Oferecemos soluções especializadas para garantir resultados excepcionais e duradouros.',
    projetos:'Nossa equipe trabalha na concepção de projetos inovadores, oferecendo soluções que combinam estética e funcionalidade para atender às aspirações de nossos clientes.', 
